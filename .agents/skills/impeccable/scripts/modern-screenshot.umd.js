;(function (y, v) {
	...
	function me(e, t) {
		return C(this, null, function* () {
			V(e) &&
				($(e) || Y(e) ? yield L(e, t) : yield Promise.all(['img', 'video'].flatMap((r) => Array.from(e.querySelectorAll(r)).map((n) => L(n, t)))))
		})
	}
	const he = (function () {
		let t = 0
								...
								try {
									...
									return (
										...
										(b.onmessageerror = (w) => {
											var T, A
											const { url: S } = w.data
											;(A = (T = u.get(S)) == null ? void 0 : T.reject) == null || A.call(T, new Error(`Error receiving message from worker: ${S}`))
										}),
										b
									)
								} catch (b) {
	...
	function Rt(e, t, r, n) {
		...
		l.delete('transition-property'),
			...
			le &&
				...
				(((m = l.get('overflow-x')) == null ? void 0 : m[0]) === 'hidden' || ((f = l.get('overflow-y')) == null ? void 0 : f[0]) === 'hidden') &&
...
`
			...
			l == null || l(E, p), yield Promise.all([...Array.from({ length: 4 })].map(b)), i.timeEnd('embed node'), yield f == null ? void 0 : f(g)
			const w = Yt(g, r)
