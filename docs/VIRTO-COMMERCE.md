...
4. What that module does. `@misiki/virto-connector` already carries its own `setStaticStore`,
   ...
   `src/lib/core/connectors/virto.ts` is thin on purpose: it re-exports the package, exports the
