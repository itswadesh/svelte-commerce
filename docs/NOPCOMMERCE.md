...
4. What that module does. `@misiki/nopcommerce-connector` already carries its own `setStaticStore`,
   ...
   `src/lib/core/connectors/nopcommerce.ts` is thin on purpose: it re-exports the package, exports the
