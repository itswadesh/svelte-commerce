...
4. What that module does. `@misiki/woocommerce-connector` already carries its own `setStaticStore`,
   ...
   `src/lib/core/connectors/woocommerce.ts` is thin on purpose: it re-exports the package, exports the
