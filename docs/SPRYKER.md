...
4. What that module does. `@misiki/spryker-connector` already carries its own `setStaticStore`,
   ...
   `src/lib/core/connectors/spryker.ts` is thin on purpose: it re-exports the package, exports the
