...
4. What that module does. `@misiki/cs-cart-connector` already carries its own `setStaticStore`,
   ...
   `src/lib/core/connectors/cs-cart.ts` is thin on purpose: it re-exports the package, exports the
