...
4. What that module does. `@misiki/sylius-connector` already carries its own `setStaticStore`,
   ...
   `src/lib/core/connectors/sylius.ts` is thin on purpose: it re-exports the package, exports the
