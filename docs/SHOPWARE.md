...
4. What that module does. `@misiki/shopware-connector` already carries its own `setStaticStore`,
   ...
   `src/lib/core/connectors/shopware.ts` is thin on purpose: it re-exports the package, exports the
