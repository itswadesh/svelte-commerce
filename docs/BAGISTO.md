...
4. What that module does. `@misiki/bagisto-connector` already carries its own `setStaticStore`,
   ...
   `src/lib/core/connectors/bagisto.ts` is thin on purpose: it re-exports the package, exports the
