...
4. What that module does. `@misiki/x-cart-connector` already carries its own `setStaticStore`,
   ...
   `src/lib/core/connectors/x-cart.ts` is thin on purpose: it re-exports the package, exports the
