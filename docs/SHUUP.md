...
4. What that module does. `@misiki/shuup-connector` already carries its own `setStaticStore`,
   ...
   `src/lib/core/connectors/shuup.ts` is thin on purpose: it re-exports the package, exports the
