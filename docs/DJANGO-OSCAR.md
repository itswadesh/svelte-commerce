...
4. What that module does. `@misiki/oscar-connector` already carries its own `setStaticStore`,
   ...
   `src/lib/core/connectors/oscar.ts` is thin on purpose: it re-exports the package, exports the
