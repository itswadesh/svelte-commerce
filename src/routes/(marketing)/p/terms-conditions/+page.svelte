		...
		<ul class="flex flex-col gap-5 text-sm sm:text-base">
			<li>
				...
				<p class="text-gray-500">
					Welcome to our online store! Misiki and its associates provide their services to you
			...
			<li>
				...
				<p class="text-gray-500">
					When you visit Misiki or send e-mails to us, you are communicating with us electronically.
			...
			<li>
				...
				<p class="text-gray-500">
					Misiki’s trademarks and trade dress may not be used in connection with any product or
			...
			<li>
				...
				<p class="text-gray-500">
					Misiki grants you a limited license to access and make personal use of this site and not
			...
			<li>
				...
				<p class="text-gray-500">
					All items purchased from Misiki are made pursuant to a shipment contract. This basically
			...
			<li>
				...
				<p class="mb-5 text-gray-500">
					Misiki and its associates attempt to be as accurate as possible. However, Misiki does not
					warrant that product descriptions or other content of this site is accurate, complete,
					reliable, current, or error-free.
				</p>

				<p class="text-gray-500">
					Disclaimer of warranties and limitation of liability this site is provided by misiki on an
			...
			<li>
				...
				<p class="text-gray-500">
					By visiting Misiki, you agree that the laws of the state of ODISHA, INDIA, without regard
			...
			<li>
				...
				<p class="text-gray-500">
					Any dispute relating in any way to your visit to Misiki or to products you purchase
