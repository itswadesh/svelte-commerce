	...
	<div class="container mx-auto w-full max-w-6xl">
		...
		<div class="prose max-w-none">
			...
			<div>
				<ul>
					...
					<li>
						<p>
							...
							&apos;Us&apos; or &apos;Our&apos; in this Agreement) refers to Misiki, .
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Misiki, accessible from
							<a
								href="https://misiki.in"
								target="_blank"
				...
				<p><strong>Compliance with Google Play Console Policies&nbsp;</strong><br /></p>
				<p></p>
				<ul>
					<li>
						<p>
							This Privacy Policy is accessible from our App listing page on Google Play
							Console.&nbsp;
						</p>
					</li>
					<li>
						<p>
							This Privacy Policy references Misiki as named in the app&apos;s Google Play
							listing.&nbsp;
						</p>
					</li>
					<li>
						<p>
							This Privacy Policy is clearly labeled as a privacy policy. Contact information for
							privacy inquiries is provided within the Privacy Policy.&nbsp;
						</p>
					</li>
					<li>
						<p>
							This Privacy Policy is readable in a standard browser without any plug-ins or special
							handlers (no PDFs).&nbsp;
						</p>
					</li>
					<li>
						<p>
							This Privacy Policy is available on an active, publicly accessible, and non-geofenced
							URL.&nbsp;
						</p>
					</li>
					<li>
						<p>This Privacy Policy is non-editable.&nbsp;</p>
					</li>
					<li>
						<p>
							This Privacy Policy comprehensively discloses how the App accesses, collects, uses,
				...
				<h3>Secure Data Handling Procedures:<br /></h3>

				<ul>
					<li>
						<span style="font-size: 19px"
							>Encryption:&nbsp;Use strong encryption algorithms to secure both data in transit and
							data at rest and&nbsp;</span
						><span style="font-size: 19px">I</span><span style="font-size: 19px"
							>mplement end-to-end encryption for sensitive user communications.</span
						>​
					</li>
					<li>
						<span style="font-size: 19px">Access Controls:</span><span style="font-size: 19px"
						></span
						><span style="font-size: 19px"
							>Enforce strict access controls to limit who can access sensitive data and&nbsp;</span
						><span style="font-size: 19px"
							>&nbsp;Implement the principle of least privilege, ensuring that individuals only have
							access to the data necessary for their role.
						</span>
					</li>
					<li>
						<span style="font-size: 19px">Authentication and Authorization: </span><span
							style="font-size: 19px"
							>Implement multi-factor authentication for accessing sensitive systems and&nbsp;</span
						><span style="font-size: 19px"
							>Regularly review and update user permissions based on job roles.
						</span>
					</li>
					<li>
						<span style="font-size: 19px">Data Minimization: </span><span style="font-size: 19px"
							>Collect and store only the minimum amount of data necessary for the intended purpose
							and&nbsp;</span
						><span style="font-size: 19px">Regularly review and purge unnecessary data. </span>
					</li>
					<li>
						<span style="font-size: 19px">Data Integrity:</span><span style="font-size: 19px"
							>&nbsp;Implement mechanisms to ensure the accuracy and integrity of stored data
							and&nbsp;</span
						><span style="font-size: 19px"
							>Monitor for any unauthorized changes to sensitive data.
						</span>
					</li>
					<li>
						<span style="font-size: 19px">Secure Development Practices:</span><span
							style="font-size: 19px"
							>&nbsp;Follow secure coding practices to prevent common vulnerabilities and&nbsp;</span
						><span style="font-size: 19px"
							>Regularly conduct security code reviews and penetration testing.
						</span>
					</li>
					<li>
						<span style="font-size: 19px">Incident Response Plan: </span><span
							style="font-size: 19px"
							>Develop and maintain an incident response plan to address any data breaches promptly
							and&nbsp;</span
						><span style="font-size: 19px"
							>Communicate transparently with affected users in the event of a breach.</span>
					</li>
				</ul>

				<h3><span style="font-size: 19px"><br /> </span></h3>

				<h3><span style="font-size: 19px">Data Retention and Deletion Policy</span></h3>

				<ul>
					<li>
						<span style="font-size: 19px"
							>Data Retention: Clearly define the purposes for which data is collected and retained
					...
					<li>
						<span style="font-size: 19px"
							>Data Deletion: Implement automated processes for data deletion after the expiration
							of retention periods, allow users to request the deletion of their data, and provide a
							straightforward mechanism for fulfilling such requests.
						</span>
					</li>
					<li>
						<span style="font-size: 19px"
							>Backup and Archiving: Clearly differentiate between active data, backups, and
							archives and Implement secure and monitored backup and archive procedures.&nbsp;</span
						><br />
					</li>
				</ul>
