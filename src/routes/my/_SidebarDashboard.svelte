...
<section
	class="overflow-hidden h-full w-24 sm:w-40 bg-white shadow-lg border py-4 sm:px-4  text-sm text-gray-800 flex flex-col items-center justify-around">
	<a
		href="/my"
		...
		<h6 class="mt-2 text-sm sm:text-base font-semibold group-hover:text-primary-500">Dashboard</h6>
	</a>
	...
	<a
		...
		<h6 class="mt-2 text-sm sm:text-base font-semibold group-hover:text-primary-500">My Orders</h6>
	</a>
	...
	<a
		...
		<Icon
			src="{UserCircle}"
			class="h-6 w-6 sm:h-8 sm:w-8 text-gray-500 group-hover:text-primary-500" />
		<h6 class="mt-2 text-sm sm:text-base font-semibold group-hover:text-primary-500">Profile</h6>
	</a>
	...
	<!-- <button
		...
		<h6 class="mt-2 text-sm sm:text-base font-semibold">Customers</h6>
	</button> -->
	<button
		on:click="{logout}"
		class="flex flex-col items-center justify-center focus:outline-none w-full py-2 group">
		<Icon src="{Logout}" class="h-6 w-6 sm:h-8 sm:w-8 text-gray-500 group-hover:text-primary-500" />
		<h6 class="mt-2 text-sm sm:text-base font-semibold group-hover:text-primary-500">Logout</h6>
	</button>
	...
	<div class="mt-10 relative flex flex-col items-center justify-center">
		...
		<div class="absolute inset-x-0  top-0 -mt-10 flex flex-col items-center justify-center">
			<h6 class="mb-1 text-sm sm:text-base font-semibold">Tip</h6>
			<div
