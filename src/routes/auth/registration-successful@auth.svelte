...
const seoProps = {
	...
	metadescription: 'Registration Successful'
}
...
<div
	...
	<div class="mb-5 text-center font-bold uppercase">Registration Successful</div>
	...
	<h6 class="mb-5 text-center text-gray-600">You need to login</h6>
