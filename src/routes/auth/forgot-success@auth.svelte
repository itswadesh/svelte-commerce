...
const seoProps = {
	...
	metadescription: 'Forgot Success'
}
...
<div
	...
	<div class="mb-5 text-center font-bold uppercase">FORGOT SUCCESS</div>
	...
	<a href="https://mail.google.com" class="mx-auto mb-5 font-medium"> Check Your Email Inbox </a>

	<div class="flex items-center justify-center">
		<a
			href="{$loginUrl}?ref=/auth/forgot-success"
