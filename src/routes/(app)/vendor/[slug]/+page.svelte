...
<section class="min-h-screen">
	<div class="h-rem relative mb-4 w-full sm:mb-10">
		...
		<div
			class="absolute inset-0 flex items-end justify-center h-full w-full bg-gradient-to-t from-black via-transparent p-3 py-5 sm:p-10">
			<div class="container max-w-6xl flex flex-col items-start gap-2 text-white sm:gap-4">
				<div class="flex flex-wrap items-end gap-2 sm:gap-4">
					<!-- Business name -->

					<h2 class="text-xl font-extrabold sm:text-4xl lg:text-6xl">
