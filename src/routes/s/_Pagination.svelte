...
{#if count > 1}
	<div class="flex items-center justify-between">
		...
		<div class="flex items-center justify-center flex-1 text-center">
			{#if current > 1}
				<button
					class="inline-flex items-center p-2 font-semibold text-gray-800 bg-white border border-gray-400 shadow lg:mx-5 hover:bg-gray-100 lg:py-2 lg:px-4"
			...
			{#each { length: pages } as _, i}
				<button
					class="w-8 h-8 px-2 py-1 border  lg:mx-2 hover:border-gray-500"
