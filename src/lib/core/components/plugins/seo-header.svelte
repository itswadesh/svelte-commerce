<script lang="ts">
	...
	let { metaTitle = '', metaDescription = '', metaKeywords = '', image = '', canonicalUrl = '', noindex = false } = $props()
	...
	const finalDescription =
		metaDescription ||
		page.data?.store?.description ||
		`Discover the best deals on women's fashion at ${storeName}. Shop dresses, co-ord sets, and more with up to 70% off. Free delivery available.`
</script>
