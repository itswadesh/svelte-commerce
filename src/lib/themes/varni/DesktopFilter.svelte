...
<div
	class="{clazz} flex h-[85vh] w-56 shrink-0 flex-col items-start overflow-hidden p-4 rounded border scrollbar-thin scrollbar-thumb-slate-200">
	<h2 class="uppercase font-bold text-primary-500">Shop by</h2>
	...
	{#if megamenu?.length}
		<div class="my-3">
			...
			<h6 class="mb-3 text-sm uppercase font-semibold text-primary-500">Categories</h6>
