...
{#if categoryPool?.length}
	<ul
		class="w-[93vw] sm:w-full flex sm:flex-wrap items-center justify-start sm:justify-center gap-2 sm:gap-5 overflow-x-auto sm:overflow-x-visible scrollbar-none">
