...
>
	{#if !forgotPasswordModule.success}
		<div
			class="w-full transform space-y-6 border border-gray-100/50 bg-white/70 p-6 shadow-2xl ring-1 ring-white/20 backdrop-blur-xl transition-all dark:border-gray-700/50 dark:bg-gray-900/80 dark:ring-white/5 sm:max-w-[480px] sm:rounded-2xl sm:p-8"
		>
			<!-- Close Icon -->
