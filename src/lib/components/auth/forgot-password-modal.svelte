...
<Modal {show} hideHeader hideFooter useMaxHeight class="p-0 max-sm:h-screen max-sm:w-screen" hAuto wAuto rounded={false}>
	{#if !forgotPasswordModule.success}
		<div class="flex items-center justify-center bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center space-x-3">
            ...
            <p class="text-gray-600 dark:text-gray-300">Quick & secure password reset</p>
				...
				<!-- Right side - Form -->
				<div class="w-full max-w-md transform space-y-6 rounded-lg bg-white/80 p-8 backdrop-blur-sm transition-all dark:bg-gray-800/90">
