			...
			<div class="container mx-auto flex items-start justify-start gap-4">
				{#each { length: 8 } as _}
					<div class="flex flex-col items-center">
						<div class="mb-1 h-16 w-16 animate-pulse rounded-full bg-zinc-200 sm:mb-4"></div>
					...
					{#if category.img}
						<div class="pr-3">
							<a
								...
								<h6
									class="w-full truncate overflow-ellipsis text-center text-xs capitalize tracking-tighter text-zinc-500 group-hover:font-medium group-hover:text-primary-500">
									{category.name}
								</h6>
							</a>
						</div>
