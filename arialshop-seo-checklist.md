...
- [ ] **[HIGH]** Add `Organization` JSON-LD to homepage / root layout
  ...
  ```json
  {
  	...
  	"sameAs": ["https://www.instagram.com/arialshop", "https://www.facebook.com/arialshop"]
  }
  ```
...
_Generated by Swadesh Behera / Misiki Technologies — arialshop.com SEO audit, April 2026_
